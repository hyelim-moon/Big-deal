...
public class MemberServiceTest {
    ...
    public void verifiedEmailTest() {
        ...
        Assertions.assertDoesNotThrow(()->service.verifiedEmail(new VerifiedMemberRequest("choda1510@kyungmin.ac.kr", "123456")));
    }
    @Test
    public void verifiedEmailInvalidateEmailTest() {
        service.sendCodeToEmail("choda1510@kyungmin.ac.kr");

        Assertions.assertThrows(EmailNotFoundException.class, ()->service.verifiedEmail(new VerifiedMemberRequest("choda1111@kyungmin.ac.kr","123456")));
    }
    @Test
    public void verifiedEmailInvalidateCodeTest() {
        service.sendCodeToEmail("choda1510@kyungmin.ac.kr");
    ...
    @Test
    public void sendEmailAlreadyExistTest() {
        AddMemberRequest request = new AddMemberRequest("id1", "password1", "member1@email.com");
        service.insert(request);

        Assertions.assertThrows(MemberEmailDuplicateException.class, ()->service.sendCodeToEmail(request.getEmail()));
    }
    @Test
    ...
    @Test
    public void usernameDuplicationUpdateExceptTest() {
        AddMemberRequest request1 = new AddMemberRequest("id1", "password1", "member1@email.com");
    ...
    @Test
    public void nullExceptUpdateTest() {
        AddMemberRequest request = new AddMemberRequest("id1", "password1", "id1@email.com");
        MemberResponse response = service.insert(request);

        Assertions.assertDoesNotThrow(()->service.update(response.getUuid(), new UpdateMemberRequest(null, null, null)));
        MemberResponse member = service.findById(response.getUuid());

        Assertions.assertEquals(request.getUsername(), member.getUsername());
        Assertions.assertEquals(request.getEmail(), member.getEmail());
    }
    @Test
