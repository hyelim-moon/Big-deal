        ...
        http
                ...
                .authorizeHttpRequests((authorizeRequest) -> {
                    authorizeRequest
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/v1/rating/**").permitAll()
                            .requestMatchers(HttpMethod.POST, "/api/v1/rating").hasAuthority("ROLE_USER")
                            .requestMatchers(HttpMethod.PUT, "/api/v1/rating").hasAuthority("ROLE_USER")
                            .requestMatchers(HttpMethod.DELETE, "/api/v1/rating").hasAuthority("ROLE_USER")
